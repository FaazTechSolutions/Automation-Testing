...
test.describe('Helpdesk', () => {
    ...
    test.beforeEach(async ({ page }) => {
        ...
        await test.step('Login the mawarid portal', async () => {
            ...
            await loginPage.login('m.krishna', '123456');
        });
    ...
    test.describe('Requests', () => {
        test('My Requests: should filter, select, and validate requests in My Requests menu', async ({ page }) => {
            ...
            await test.step('check the my request menu', async () => {
                ...
                await page.locator('.table_filter_text').first().fill('TRQ0016253');
                await page.locator('.table_filter_text').first().press('Enter');
                await expect(page.getByText('TRQ0016253')).toBeVisible();
                await page.getByRole('cell', { name: 'Test Ticket for Playwright' }).locator('a').click();
                // Goto details page
                await expect(page.getByText('Details')).toBeVisible();
                // await expect(page.locator('#custom_template_dynamic_list_EFN0000114 div').filter({ hasText: 'Test Ticket for Playwright' }).nth(1)).toBeVisible();
                await page
                    .locator('#custom_template_dynamic_list_EFN0000114 div')
                    .filter({ hasText: 'Test Ticket for Playwright' })
                    .nth(1)
                    .waitFor({ state: 'visible' });

                // Validate Details page Actions
                await expect(page.locator('dynamic-details form div').filter({ hasText: 'Request Id TRQ0016253 Title' }).nth(1)).toBeVisible();
                await expect(page.locator('dynamic-details form div').filter({ hasText: 'On Behalf of Assigned To' }).nth(1)).toBeVisible();
                await expect(page.getByText('Please note don\'t take any').nth(1)).toBeVisible();
                ...
                await expect(page.locator('dynamic-field').filter({ hasText: 'Assigned To Assigned To m.' }).locator('#dynamic-undefined-undefined')).toBeVisible();
                ...
                await page.locator('#autoComplete_dropdown_TicketCategory comp-pagination a').first().click();
                await expect(page.locator('#autoComplete_dropdown_tableTicketCategory tbody').getByText('Portal')).toBeVisible();
                await page.locator('tr').filter({ hasText: 'IT Portal' }).locator('i').click();
                await page.locator('tr').filter({ hasText: 'IT Portal' }).locator('span').first().click();
                // Assign to Dropdown
                await page.locator('#relation_autoComplete_dropdown_AssignedTo label').nth(1).click();
                await expect(page.getByText('a.hyder')).toBeVisible();
                await page.locator('ul').filter({ hasText: 'of73' }).locator('a').nth(2).click();
                ...
                await page.locator('ul').filter({ hasText: 'of73' }).locator('a').nth(3).click();
                await expect(page.getByText('a.Aldhubayban@mawarid.com.sa').first()).toBeVisible();
                await page.locator('ul').filter({ hasText: 'of73' }).locator('a').nth(1).click();
                await page
                    .getByText('n.alzahrani@mawarid.com.sa')
                    .first()
                    .waitFor({ state: 'visible' });

                await page.locator('ul').filter({ hasText: 'of73' }).locator('a').first().click();
                ...
                await expect(page.locator('#Actionform_EFN0000178').getByText('Accept')).toBeVisible();
                ...
                await page.locator('#autoComplete_dropdown_table_Approvers').getByText('page 73').click();
                await expect(page.getByText('Hamid Kamal Khan')).toBeVisible();
                await page.locator('#autoComplete_dropdown_table_Approvers').getByText('page 72').click();
                await expect(page.locator('#autoComplete_dropdown_table_Approvers').getByText('Previous page')).toBeVisible();
                ...
                await expect(page.locator('div').filter({ hasText: /^Please note don't take any actionsType here\.\.\.$/ }).locator('div')).toBeVisible();
                ...
                await page.locator('#relation_autoComplete_dropdown_DepartmentMember div').filter({ hasText: 'Assinged To *' }).locator('label').nth(1).click();
                ...
                await page.getByText('ajeesh@faaztechsolutions.com').click();
                await page.getByPlaceholder('Comments').click();
                await page.getByPlaceholder('Comments').fill('test');
                await page.locator('#pills-tabContent').getByText('Close').click();
                await page.locator('#cdk-drop-list-8 a').filter({ hasText: 'Approvals' }).click();
                await page.locator('#cdk-drop-list-8 li').filter({ hasText: 'Task' }).locator('a').click();
                ...
                await page.getByRole('cell', { name: '⯆ TRQ0016253' }).hover();
                await page.getByRole('cell', { name: '⯆ TRQ0016253 ' }).getByRole('textbox').nth(1).hover();
                await page.getByRole('cell', { name: '⯆ TRQ0016253 ' }).locator('i').click();
        ...
        test('Assigned To Me: should filter, select, and validate requests assigned to the user', async ({ page }) => {
            await test.step('check the AssignedToMe menu', async () => {
                ...
                await page.locator('comp-pagination a').nth(2).click();
                await page.locator('comp-pagination a').nth(2).click();
                await expect(page.getByRole('cell', { name: 'TRQ0010713' }).locator('comp-datatype')).toBeVisible();
                await page.locator('comp-pagination a').nth(1).click();
                ...
                await page.locator('.text-left > .clearfix > .table_filter_text').first().fill('Test ticket 2 for Automation test');
                await page.locator('.text-left > .clearfix > .table_filter_text').first().press('Enter');
                await expect(page.getByRole('cell', { name: 'Test ticket 2 for Automation test', exact: true }).locator('a')).toBeVisible();
                await page.getByRole('cell', { name: 'Test ticket 2 for Automation test', exact: true }).locator('a').click();
                await expect(page.locator('#custom_template_dynamic_list_EFN0000114').getByText('Test ticket 2 for Automation test')).toBeVisible({ timeout: 20000 });
                ...
                await page.locator('a').filter({ hasText: 'Assignment' }).click();
                await expect(page.locator('#dynamic_list_EFN0000108 comp-table tbody').getByText('Test ticket 2 for Automation')).toBeVisible();
        ...
        test('My Open Requests: should filter, select, and validate open requests assigned to the user', async ({ page }) => {
            await test.step('myOpenRequest menu test', async () => {
                ...
                // await expect(page.getByText('My Open Request', { exact: true })).toBeVisible();
                await page
                ...
                await expect(page.locator('#relation_autoComplete_dropdown_AssignedTo').getByText('m.krishna')).toBeVisible();
                ...
                await expect(page.locator('tr').filter({ hasText: 'm.krishna Krishna m.krishna@' }).locator('comp-field-view-type').nth(1)).toBeVisible();
                ...
                await page.getByPlaceholder('Scheduled Date').click();
                ...
                await expect(page.locator('#Actionform_EFN0000179').getByText('Cancel')).toBeVisible();
                await page.locator('#Actionform_EFN0000179').getByText('Close').click();
                await page.getByText('Close').nth(2).click();
                // Close Action validations
                await expect(page.locator('h4').filter({ hasText: 'Close' })).toBeVisible();
                await page.locator('#Actionform_EFN0000182 button').filter({ hasText: 'Close' }).click();
                // Attach Action validations
                ...
                await page.getByText('page 3').click();
                await expect(page.getByText('a.aldursuni@mawarid.com.sa').first()).toBeVisible();
                await page.getByText('page 73').click();
                await expect(page.getByText('Hamid Kamal Khan')).toBeVisible();
                await page.getByText('Previous page').click();
                await expect(page.getByText('m.alshehri@mawarid.com.sa').first()).toBeVisible();
                await page.getByText('page 1').click();
                ...
                await page.locator('a').filter({ hasText: 'Assignment' }).click();
                await expect(page.locator('#dynamic_list_EFN0000108 comp-table tbody').getByText('Test ticket 2 for Automation')).toBeVisible();
                await expect(page.locator('#dynamic_list_EFN0000108 comp-table tbody').getByText('m.krishna', { exact: true })).toBeVisible();
                await page.locator('a').filter({ hasText: 'Conversation' }).click();
                await expect(page.getByText('Krishna Assigned To Krishna 4')).toBeVisible();
                ...
                await page.locator('#autoComplete_dropdown_tableDepartmentMember input[type="text"]').first().fill('viswa');
                await page.locator('#autoComplete_dropdown_tableDepartmentMember input[type="text"]').first().press('Enter');
                await page.locator('#autoComplete_dropdown_tableDepartmentMember i').click();
                await page.getByPlaceholder('Comments').click();
                await page.getByPlaceholder('Comments').fill('test');
                await page.locator('#pills-tabContent').getByText('Close').click();
